...
export const userActionTypes = {
  ...
  UPDATE_LIKED_POSTS: 'UPDATE_LIKED_POSTS',
...
export const profileXActionTypes = {
  ...
  FOLLOW_SUCCESS: 'FOLLOW_SUCCESS',
  DECREASE_LIKED_POST: 'DECREASE_LIKED_POST',
  UNFOLLOW_SUCCESS: 'UNFOLLOW_SUCCESS',
};
...
export const studentDataActionTypes = {
  FETCH_EVENTS_SUCCESS: 'FETCH_EVENTS_SUCCESS',
  FETCH_MAGAZINE_SUCCESS: 'FETCH_MAGAZINE_SUCCESS',
  FETCH_PLACEMENT_DATA_SUCCESS: 'FETCH_PLACEMENT_DATA_SUCCESS',
  LOAD_MORE_EVENTS_SUCCESS: 'LOAD_MORE_EVENTS_SUCCESS',
  LOAD_MORE_PLACEMENT_DATA_SUCCESS: 'LOAD_MORE_PLACEMENT_DATA_SUCCESS',
  TOGGLE_ALL_LOADED_EVENTS_SUCCESS: 'TOGGLE_ALL_LOADED_EVENTS_SUCCESS',
  TOGGLE_ALL_LOADED_PLACEMENT_SUCCESS: 'TOGGLE_ALL_LOADED_PLACEMENT_SUCCESS',
  REQUEST_FAILURE: 'FOLLOW_LIST_FAILURE',
};

export const LIMIT_POSTS_PER_LOADING = 5;
export const LIMIT_EVENTS_PER_LOADING = 15;
export const LIMIT_PLACEMENT_DATA_PER_LOADING = 20;
